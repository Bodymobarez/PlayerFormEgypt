      ...
      asyncHandler(async (req, res) => {
        const CLUBS_DATA = [
          ...
          },
          {
            ...
            primaryColor: "hsl(200 70% 45%)",
            username: "gouna",
            password: "gouna123",
            assessmentPrice: 4500,
          },
          {
            clubId: "ghazl-elmahalla",
            name: "غزل المحلة",
            logoUrl: "/logos/ghazl_elmahalla.png",
            primaryColor: "hsl(120 50% 40%)",
            username: "ghazl",
            password: "ghazl123",
          ...
          },
          {
            clubId: "el-dakhleya",
            name: "نادي الداخلية",
            logoUrl: "/logos/el_dakhleya.png",
            primaryColor: "hsl(220 60% 35%)",
            username: "dakhleya",
            password: "dakhleya123",
            assessmentPrice: 3500,
          },
          {
            clubId: "nbe",
            name: "البنك الأهلي",
            logoUrl: "/logos/national_bank.png",
            primaryColor: "hsl(160 60% 35%)",
            username: "nbe",
            password: "nbe123",
            assessmentPrice: 4000,
          },
