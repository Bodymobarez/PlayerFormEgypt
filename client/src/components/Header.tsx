...
export const CLUBS: ClubData[] = [
  { id: "al-ahly", name: "النادي الأهلي", primaryColor: "hsl(354 70% 45%)", assessmentPrice: 5000, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/f/f6/Al_Ahly_SC.png" },
  { id: "zamalek", name: "نادي الزمالك", primaryColor: "hsl(222 47% 11%)", assessmentPrice: 5000, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/7/72/Zamalek_SC.png" },
  { id: "pyramids", name: "نادي بيراميدز", primaryColor: "hsl(210 60% 30%)", assessmentPrice: 4500, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/8/8a/Pyramids_FC.png" },
  { id: "al-masry", name: "النادي المصري", primaryColor: "hsl(140 60% 35%)", assessmentPrice: 4500, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/9/90/Al_Masry_SC.png" },
  { id: "ismaily", name: "النادي الإسماعيلي", primaryColor: "hsl(45 90% 50%)", assessmentPrice: 4000, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/7/7d/Ismaily_SC.png" },
  ...
  { id: "enppi", name: "إنبي", primaryColor: "hsl(200 75% 45%)", assessmentPrice: 3500, wikipediaLogo: "https://upload.wikimedia.org/wikipedia/en/2/2a/ENPPI_SC.png" },
